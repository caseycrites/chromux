...
var currentSession = {name: '', focusedWindow: -1, activeTab: -1, windows: {}, tabs: {}}
...
function defineCommands() {
  commands = {
    save: {
      description: "Save the current browser state as a chromux session.",
